...
-   preventing manual, error-prone work copy-pasting code from one file to another,
...
1. Use (parts of) an external script *within* the Quarto document, for example to use objects that were created within that script.
2. Run a script before or after rendering a Quarto document to a manuscript.
...
1.  Complete the provided code (in the course book) to include the `do_addition` function into your Quarto document.

2.  Use the `do_addition` function to add two numbers of your choice to test whether your previous code was correct!
